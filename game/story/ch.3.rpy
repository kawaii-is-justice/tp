label loop_3:
   ...
   show nuri at center, ishade with dissolve
   ...
   n "오~ 전학생! 감이 좋은걸~ \n나는 {color=#FFAEC9}누리{/color}야. 전학생은 이름이 뭐야?"
   ...
   h "당신... 당신 때문이에요... 알고 계셨나요?{w=2.0}{nw}"
   h "주머니를 확인해 보세요."
   ...
   "갑자기 엄청난 두통이 느껴지고 숨이 쉬어지지 않았다."
   p "{cps=10}......아파... 숨이......{/cps}{w=1.0}{nw}" with vpunch
   "나는 그대로 무너져 쓰러졌다."

   stop music fadeout 0.5
   scene bg school nurseoffice with Fade(1.0, 1.0, 1.0)
   play music general2 fadein 1.0
   ...
   "벌써 점심시간인 건지, 급식실엔 맛있는 냄새가 퍼지고 학생들도 많았다."
   ...
   stop music fadeout 1.0
   scene bg school hallway with Fade(1.0, 1.0, 1.0)
   play music general2 fadein 1.0

   "점심을 먹고 반으로 돌아가려던 참이었다. 그런데, 또 한 번 반장인 하늘이에게 붙잡히고 말았다."
   "내가 없어진 걸 깨달은 누리는 고개를 돌려 나를 찾다 하늘이와 눈이 마주치곤 조용히 고개를 숙이고 반으로 돌아갔다."

   show hanl say at center, doup with dissolve

   h "이제 당신도... \n어느 정도 눈치채셨을 거라고 생각합니다..."
   h "궁금한 게 있다면 언제든지 도서관으로 찾아와 주세요."

   hide hanl with dissolve
   window hide dissolve

   scene bg school classroom afternoon with Fade(1.0, 1.0, 1.0)
   show nuri at center with dissolve

   p "누리 너는 하늘이에 대해 잘 알아?"

   show nuri say at doup

   n "반장? 음... 엄청 친하진 않아도 이것저것 도움을 받고 있긴 하지... 특히 공부에서."
   ...
   "그러나 누리가 말을 끝마치기도 전에, 하늘이가 조용히 내 팔을 잡은 채 나를 교실 밖으로 데리고 나갔다."
   ...
   h "그리고 지금이라면 당신에게 진실을 어느 정도 말씀드릴 수 있을지도 모르겠군요."

   "누리가... 위험한 상태라고? 방금 전 교실에서 본, 그 붉은 경고 메시지 때문인건가?"
   "하늘이는 마치 무언가에 홀린 듯, 나를 복도 저편으로 이끌었다."
   "우리가 도착한 곳은,"

   scene bg school library afternoon with Dissolve(1.0)
   show hanl at center, doup with dissolve

   "조용한 도서관이었다. \n텅 빈 공간에 우리의 발소리만이 들렸다."
   h "잠시만 기다려주시겠습니까."

   hide hanl with dissolve

   "하늘이는 어둠이 짙게 깔린 책장 사이로 사라졌다."
   "도서관 안을 좀 둘러볼까......"
   ...
   menu:
      ...
      "(주위를 둘러본다.)":
         "주위를 둘러봤지만, 특별한 건 없었다."
         "...아침에도, 하늘이에게 이끌려 도서관에 왔었지... 하늘이는 도서관에 있는걸 좋아하는 모양이다."
         "오가는 사람도 별로 없는걸 보니, 대화하기 좋은 장소라고 생각하고 있을지도..."
      ...
      "(누리에게 돌아가본다.)":
         ...
         scene bg school classroom afternoon with Dissolve(1.0)
         show nuri sad at center with dissolve

         "조심스럽게 교실 문을 열자, 누리가 고개를 숙인 채 책상에 엎드려 있었다. 누리의 어깨가 작게 떨리는 것이 보였다."
         p "누리야... 괜찮아?"
         "누리는 내 목소리에 놀란 듯 고개를 들었다. 울고 있었던 건지, 눈시울이 붉었다."
         n "너... 왜 다시 왔어? \n반장이랑 있는 게 더 좋은 거 아니었어?"
         ...
         "그 순간, 뒤에서부터 작은 발소리와 함께 하늘이의 차갑고 날카로운 목소리가 들려왔다."

         show nuri sad at chls with ease
   ...
   if loop_3_wait_for_hanl:
      "나는 텅 빈 도서관에서 하늘이가 돌아오기를 기다렸다. \n잠시 후, 하늘이가 손에 노트 한 권을 들고 돌아왔다."
      h "기다려주셔서 감사합니다."
   else:
      "나는 하늘이의 손에 이끌려 다시 도서관으로 돌아왔다. \n도서관의 책상 위에는 노트 한 권이 놓여있었다."
         
   h "{cps=6}...혹시{/cps}, 이런 상황이 불편하진 않으신가요."
   ...
   h "오늘은 여기까지 하도록 하죠. \n누리도{cps=6}...{/cps} 곧 괜찮아질 겁니다."
   h "어쩌면{cps=10}...{/cps} \n당신이 해결할 수 있을지도 모르겠네요."
   "하늘이는 노트를 펼쳐 무언가를 열심히 쓰기 시작했다. \n무표정했지만 눈가는 미세하게 떨리고 있었다."
   "그런 하늘이를 바라보다, 눈을 깜빡였더니, {p}눈앞이 깜깜해지고 말았다."

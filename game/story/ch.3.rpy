label loop_3:
   ...
   "교실로 돌아갔더니 바로 누리에게 붙잡혀 급식실로 끌려왔다.\n벌써 점심 시간인건지, 급식실엔 맛있는 냄새가 퍼지고 학생들도 많았다."
   ...
   "내가 없어진걸 깨달은 누리는 고개를 돌려 나를 찾다\n하늘이와 눈이 마주치더니 조용히 고개를 숙이고 반으로 돌아갔다."

   show hanl

   h "이제 당신도...\n어느정도 눈치 챘을거에요.."
   h "궁금한게 있다면 언제든지 도서관으로 찾아오세요."
   ...
   n "{cps=6}...{/cps}그게 무슨 말이야.\n아까도 갑자기 데려가더니, 이번엔 또 왜?\n왜 자꾸 나랑 전학생을 떼어놓으려고 하는데...?"

   "그러나 누리가 말을 마치기도 전에 하늘이 조용히 내 팔을 잡고 교실 밖으로 데리고 나갔다."
   "뒤에서 누리의 목소리가 들려왔다."
   ...
   h "그리고 지금이라면\n당신에게 진실을 어느 정도 말씀드릴 수 있을지도 모르겠군요."
   ...
   "조용한 도서관. 텅 빈 공간에 우리의 발소리만이 들린다."

   h "잠시만 기다려주시겠습니까."

   "하늘은 책상 사이, 어둠이 짙게 깔린 안쪽으로 사라진다."
   "도서관 안을 좀 둘러볼까...."
   menu:
      "가만히 있는다.":
         "가만히 기다려보자"
      ...
      "주위를 둘러본다.":
         "주위를 둘러봤지만, 특별한건 없었다."
         "...아침에도, 하늘이에게 이끌려 도서관에 왔었지...\n하늘이는 도서관에 있는걸 좋아하는 모양이다...\n오가는 사람도 없는거 보니 대화하기 좋은 장소라고 생각하고 있을지도..."
      "누리에게 돌아가본다.":
         $ loop_3_wait_for_hanl = False
         $ hanllove -= 1
         $ nurilove += 1
         scene bg school classroom afternoon
         "조심스럽게 교실 문을 열자,\n누리가 고개를 숙인 채 책상에 엎드려었다.\n누리의 어깨가 작게 떨리고 있다."
         p "누리... 괜찮은거야?"
         "내 목소리에 놀란 듯 고개를 드는 누리.\n울고있었던건지 눈가가 붉다."
         n "너... 왜 다시 왔어?\n반장이랑 있는게 더 좋은거 아니었어?"
         n "반장은... 대체 왜 자꾸 너를 데려가는거야..."
         menu:
            "걱정돼서 돌아왔다고 한다.":
               $ nurilove += 1
            ...
            "침묵한다.":
               "누리가 다시 고개를 떨군다."
         "그 순간. 뒤에서 들려오는 작은 발소리.\n그리고 하늘이의 날카롭고 차가운 목소리가 들려왔다."
   ...
   h "오늘은 여기까지 하도록 하죠."
   h "누리도{cps=6}...{/cps} 곧 괜찮아질겁니다.\n어쩌면{cps=10}...{/cps}\n당신이 해결할 수 있을지도 모르겠네요."

   "하늘은 노트를 펼쳐 무언가를 열심히 쓰기 시작했다.\n무표정하지만 눈가는 미세하게 떨리고 있었다."

label loop_1:
    ...
    "나는 점심시간에 학교 시설 구경이라도 할 겸 돌아다니고 있었다.{p}누리가 따라오겠다는데, 겨우 떼어놓고 왔다."
...
label loop_2:
    ...
    "쪽지를 주고 받으며, 나는 누리와 이런저런 얘기를 나누었다.{p}그러다보니, 어느새 수업 끝을 알리는 종소리가 들렸다."
...
label loop_2_after_school_cafe:
    ...
    menu:
        ...
        "(먹는다)":
            "케이크가 입 안에서 녹아내린다...{p}입 안 가득 퍼지는 달콤함이 기분 좋다."
            p "정말 맛있네."
            n "그렇지~? 나도 여기 케이크는 진짜 자주 먹으러 와~"
            $ nurilove += 1
        "(먹지 않는다)":
            n "여기 케이크 진짜 맛있는데... 안 먹으면 내가 다 먹어야지!"
            "누리가 케이크를 전부 먹어치운다.{p}눈을 감고 기분 좋다는 듯이 흥얼거리는 걸 보니 정말 맛있는 모양이다."
...
label loop_2_after_school_home:
    ...
    if loop_2_nuri_company == False:
        "아까 도서관에서 하늘이가 한 말은... 무슨 뜻이었을까.{p}일단은 깊게 생각하지 않기로 했다. 별거 아니겠지."

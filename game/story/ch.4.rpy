label loop_4:
    ...
    p "아... {color=#AAAAAA}[prtname]이야."

    n "{color=#AAAAAA}[prtname]... 좋은 이름이네. 앞으로 잘 부탁해!"
    ...
    h "어떤 말 말입니까?"
    n "너가 나 보고 전학생을 멀리하는 게 좋겠다고 했잖아.\n무슨 뜻이야?"
    h "그건..."
    n "전학생이랑 얘기해보니 그리 나쁜 친구 같지도 않고,\n게다가 왠지 모르겠지만 전학생이랑 대화하면 기분이 나쁘지 않아..."
    h "...당신은 전학생에게 관심이 많군요."
    n @ surprised "에? 무, 무슨 소리를 하는 거야.\n그냥! 전학 왔는데 옆자리라 조금 챙겨주려고 한 것뿐인데..."
    h "조심하는 게 좋을지도 모릅니다."
    n "...뭐라고?"
    h "별말 아닙니다. 실례하겠습니다."
...
label evening:
    ...
    show hanl at chrs
    show nuri surprised at chls with doup
    ...
    "시야가 완전히 하얗게 물들었다."
    p "...이번에도, 끝까지 버티지 못했네.{p}언제쯤, 끝을 낼 수 있는걸까..."